...
ZamCovid <- R6::R6Class(
  ...
  private = list(
    ...
    param_ = list(G_D_transmission = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     N_tot_over15 = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     base_death_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     beta_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     cross_immunity_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     ...
     gamma_H_sev_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     ...
     gamma_R = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_U_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     gamma_sero_pos_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     gamma_sero_pre_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     ...
     k_sero_pre = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     kappa_admitted = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     kappa_death_all = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     kappa_death_hosp = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     life_exp = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     ...
     n_gamma_H_sev_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     n_gamma_sero_pos_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     n_gamma_sero_pre_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     n_p_D_hosp_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     n_p_outpx_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     n_p_sev_steps = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     p_D_hosp_step = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     ...
     p_outpx_step = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     p_sero_pos = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     p_sev_step = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     p_star_step = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     pcr_sensitivity = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     pcr_specificity = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     phi_admitted = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     phi_death_all = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     phi_death_hosp = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     re_seed_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     rel_infectivity = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_G_D = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_H_D = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_H_sev = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_H_sev_D = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_R = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_hosp_if_sympt = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     rel_p_outpx = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
     ...
     seed_age_band = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     ...
     voc_ve_inf_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     voc_ve_sev_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     voc_ve_symp_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
  ...
  public = list(
    initialize = function(pars, time, n_particles, n_threads = 1L,
      ...
      if (is.null(gpu_config)) {
        private$methods_ <- list(
           alloc = dust_cpu_ZamCovid_alloc,
           run = dust_cpu_ZamCovid_run,
           simulate = dust_cpu_ZamCovid_simulate,
           run_adjoint = dust_cpu_ZamCovid_run_adjoint,
           set_index = dust_cpu_ZamCovid_set_index,
           n_state = dust_cpu_ZamCovid_n_state,
           update_state = dust_cpu_ZamCovid_update_state,
           state = dust_cpu_ZamCovid_state,
           time = dust_cpu_ZamCovid_time,
           reorder = dust_cpu_ZamCovid_reorder,
           resample = dust_cpu_ZamCovid_resample,
           rng_state = dust_cpu_ZamCovid_rng_state,
           set_rng_state = dust_cpu_ZamCovid_set_rng_state,
           set_n_threads = dust_cpu_ZamCovid_set_n_threads,
           set_data = dust_cpu_ZamCovid_set_data,
           compare_data = dust_cpu_ZamCovid_compare_data,
           filter = dust_cpu_ZamCovid_filter,
           set_stochastic_schedule = dust_cpu_ZamCovid_set_stochastic_schedule,
           ode_statistics = dust_cpu_ZamCovid_ode_statistics)
      } else {
    ...
    has_openmp = function() {
      dust_cpu_ZamCovid_capabilities()[["openmp"]]
    },
    ...
    has_gpu_support = function(fake_gpu = FALSE) {
      if (fake_gpu) {
        ...
        dust_cpu_ZamCovid_capabilities()[["gpu"]]
      }
    },

    has_compare = function() {
      dust_cpu_ZamCovid_capabilities()[["compare"]]
    },

    real_size = function() {
      dust_cpu_ZamCovid_capabilities()[["real_size"]]
    },

    time_type = function() {
      dust_cpu_ZamCovid_capabilities()[["time_type"]]
    },

    rng_algorithm = function() {
      dust_cpu_ZamCovid_capabilities()[["rng_algorithm"]]
    },
...
class(ZamCovid) <- c("dust_generator", class(ZamCovid))
basic <- R6::R6Class(
  "dust",
  cloneable = FALSE,
  ...
  private = list(
    ...
    ode_control_ = NULL,
    methods_ = NULL,
    param_ = list(E2_ini = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     ...
     R_ini = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     S_ini = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     beta_step = list(has_default = FALSE, default_value = NULL, rank = 1, min = -Inf, max = Inf, integer = FALSE),
     eta_R = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_E = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     gamma_I = list(has_default = FALSE, default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
     m = list(has_default = FALSE, default_value = NULL, rank = 2, min = -Inf, max = Inf, integer = FALSE),
    ...
    initialize = function(pars, time, n_particles, n_threads = 1L,
      ...
      if (is.null(gpu_config)) {
        private$methods_ <- list(
           ...
           run_adjoint = dust_cpu_basic_run_adjoint,
...
ZamCovid$set("public", "transform_variables", function(y) {
    info <- self$info()
